Filtering and Collection Project
=======================================

This directory contains the modules of the Filtering and Collection project. The objective of the
...
In order to work on the Filtering and Collection (fc) module
