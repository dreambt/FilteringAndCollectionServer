...
case 57:
	...
	<TR>
	<TD WIDTH="5%"></TD>
	<TD COLSPAN="2" ALIGN="LEFT">边界描述:</TD>
	<TR>
	<TD WIDTH="5%"></TD>
	<TD WIDTH="5%"></TD>
	<TD COLSPAN="1" ALIGN="LEFT">重复周期:</TD>
	<TR>
	<TD WIDTH="5%"></TD>
	<TD WIDTH="5%"></TD>
	<TD WIDTH="5%"></TD>
	<TD COLSPAN="0" ALIGN="LEFT">值:</TD>
	<TD>
	<%
	if(getECSpec57mtemp != null){
	...
	<TD WIDTH="5%"></TD>
	<TD WIDTH="5%"></TD>
	<TD COLSPAN="1" ALIGN="LEFT">开始触发器:</TD>
	<TR>
	<TD WIDTH="5%"></TD>
	<TD WIDTH="5%"></TD>
	<TD WIDTH="5%"></TD>
	...
	<TD WIDTH="5%"></TD>
	<TD WIDTH="5%"></TD>
	<TD COLSPAN="1" ALIGN="LEFT">停止触发器:</TD>
	<TR>
	<TD WIDTH="5%"></TD>
	<TD WIDTH="5%"></TD>
	<TD WIDTH="5%"></TD>
	...
	<TD WIDTH="5%"></TD>
	<TD WIDTH="5%"></TD>
	<TD COLSPAN="1" ALIGN="LEFT">稳定区间:</TD>
	<TR>
	<TD WIDTH="5%"></TD>
	<TD WIDTH="5%"></TD>
	<TD WIDTH="5%"></TD>
	...
	<TR>
	<TD WIDTH="5%"></TD>
	<TD COLSPAN="2" ALIGN="LEFT">在报告中包含描述:</TD>
	<TD>
	<%
	if(getECSpec57mtemp != null){
	%>
	...
	<TR>
	<TD WIDTH="5%"></TD>
	<TD COLSPAN="2" ALIGN="LEFT">报告描述:</TD>
	<TD>
	<%
	if(getECSpec57mtemp != null){
